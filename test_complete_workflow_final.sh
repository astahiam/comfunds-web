...
# Complete Workflow Testing Script for ComFunds - Final Version
# This script creates cooperatives, users, businesses, and projects for testing

echo "🚀 Starting Complete Workflow Testing for ComFunds - Final Version"
echo "=================================================================="
...
# Create Hajifund Cooperative with correct registration number format
...
# Create Sidana Cooperative with correct registration number format
...
# Test user 2 (investor) - skip if already exists
print_status "Checking if Test Investor already exists..."
TEST_USER2_DATA='{
...
if echo "$TEST_USER2_RESPONSE" | grep -q "success"; then
    print_success "Test Investor 2 created"
else
    print_error "Failed to create Test Investor 2"
...
# Create Kharisma Corp business with all required fields
...
echo "   - Test Investor 2 - Investor role"
echo ""
echo "🏪 Businesses:"
...
echo ""
echo "Test Investor 2:"
echo "  Email: investor2@comfunds.com"
...
echo ""
print_success "🎉 Complete workflow testing script final version finished!"
