...
# Complete Workflow Testing Script for ComFunds
# This script creates cooperatives, users, businesses, and projects for testing

echo "🚀 Starting Complete Workflow Testing for ComFunds"
echo "=================================================="
...
echo ""
print_status "Step 1: Creating Cooperatives"
echo "-----------------------------------"
...
echo ""
print_status "Step 2: Creating Users"
echo "----------------------------"
...
if echo "$TEST_USER1_RESPONSE" | grep -q "success"; then
    print_success "Test User 1 created (member of Sidana)"
else
...
echo ""
print_status "Step 3: Creating Businesses"
echo "----------------------------------"
...
echo ""
print_status "Step 4: Creating Projects"
echo "--------------------------------"
...
COOPERATIVES_RESPONSE=$(curl -s http://localhost:8080/api/v1/cooperatives)
...
echo ""
print_success "🎉 Complete workflow testing script finished!"
